...
const Contact = () => {
 ...
 <div className="flex flex-col md:flex-row w-full h-auto md:h-[600px]">
  {/* Image & Form section, takes full width on mobile, half on tablet/desktop */}
  {/* <div className="w-full md:w-2/3 relative">
   ...
   <input type="email" name='email' value={formData.email} onChange={handleChange} placeholder="Email" className="w-full sm:w-1/2 p-3 bg-transparent bg-opacity-30 border-b placeholder-white text-white focus:outline-none focus:ring-2 focus:ring-white" />
   <input type="tel" name='phoneNumber' value={formData.phoneNumber} onChange={handleChange} placeholder="Phone Number" className="w-full sm:w-1/2 p-3 bg-transparent bg-opacity-30 border-b placeholder-white text-white focus:outline-none focus:ring-2 focus:ring-white" />
   </div>
   <div>
   <textarea rows={4} name='message' value={formData.message} onChange={handleChange} placeholder="Type your message here" className="w-full p-3 bg-transparent bg-opacity-30 border-b placeholder-white text-white focus:outline-none focus:ring-2 focus:ring-white" ></textarea>
   </div>
  ...
  {/* Contact Info section, takes full width on mobile, one-third on tablet/desktop */}
  ...
  {/* Hide the large image on mobile, make it smaller and position it for tablet/desktop */}
