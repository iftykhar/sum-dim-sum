  ...
  return (
    <footer className="bg-white">
      <section className="container mx-auto px-6 md:px-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start pt-6 pb-8">
          ...
          <div className="w-full md:w-1/3 flex flex-col items-center justify-center gap-3 mt-8 md:mt-0">
            <Image
              src="/footerlogo.png"
              alt="Company Logo"
              width={200} 
          ...
          <div className="w-full md:w-1/3 mt-8 md:mt-0">
            <ul className="flex flex-col items-end space-y-2 text-base text-gray-600">
